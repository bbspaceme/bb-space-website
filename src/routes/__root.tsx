...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "KBAI Portfolio Tracker" },
      { name: "description", content: "Track saham IDX dan ikuti index komunitas KBAI." },
      { property: "og:title", content: "KBAI Portfolio Tracker" },
      { name: "twitter:title", content: "KBAI Portfolio Tracker" },
      { property: "og:description", content: "Track saham IDX dan ikuti index komunitas KBAI." },
      { name: "twitter:description", content: "Track saham IDX dan ikuti index komunitas KBAI." },
